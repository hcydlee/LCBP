...
tiff(file="C:/sli126/GitHub/LCBP/b179roc.tiff",res=300,width=2400,height=2400,compression="lzw")
...
text(x=5,y=3,labels="ROC Curve for Cancer vs Noncancer in Validation Set 1",adj=c(0.5,0.5), cex=1.4,col=1,font=2)
text(x=5,y=1,labels=auc1,adj=c(0.5,0.5),cex=1.1,col=1,font=2)

#4 draw ROC plot
par(mai=c(1.02,1.25,0.05,0.3),mgp=c(1.5,0.5,0))
roc2<-roc(cancer_b,estp,plot=TRUE,lty=1,auc=TRUE,legacy.axes=TRUE)
