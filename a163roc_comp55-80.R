...
data<-data[which(55<=data$age & data$age<=80),]
attach(data)
...
tiff(file="C:/sli126/GitHub/LCBP/a163roc_comp55-80.tiff",res=300,width=1680,height=2400,compression="lzw")
...
text(x=5,y=3,labels=paste("ROC Curves of LCBP and ACCP from Training Set 1(age[55,80]),N=",nrow(data)),adj=c(0.5,0.5), cex=1.4,col=1,font=2)
