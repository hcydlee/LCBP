...
tiff(file="C:/sli126/GitHub/LCBP/b179roc_complt55.tiff",res=300,width=1680,height=2400,compression="lzw")
...
text(x=5,y=3,labels=paste("ROC Curves of LCBP and ACCP from Validation set 1(<55 years),N=",nrow(data)),adj=c(0.5,0.5), cex=1.4,col=1,font=2)
